...
<div class="form-floating">
  <input type="password" class="form-control" name="memberPrePwd" id="floatingPassword" placeholder="현재 비밀번호">
  <label for="floatingPassword">현재 비밀번호</label>
</div>
<div class="form-floating">
  <input type="password" class="form-control" name="memberChangePwd" id="floatingPassword" placeholder="변경할 비밀번호">
  <label for="floatingPassword">변경할 비밀번호</label>
</div>
<div class="form-floating">
  <input type="password" class="form-control" name="memberChangePwd2" id="floatingPassword" placeholder="비밀번호 확인">
...
<div id="joinlink">
<a href="<%=request.getContextPath()%>/main.jsp"><i class="bi bi-person fs-5" ></i>비밀번호 변경 취소</a>
</div>
</div>
</div>
<%-- 
